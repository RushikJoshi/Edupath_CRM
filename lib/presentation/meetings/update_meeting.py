...
with open(r'c:\Users\tanvi\AndroidStudioProjects\Edupath_CRM\lib\presentation\meetings\add_meeting_screen.dart', 'r', encoding='utf-8') as f:
    content = f.read()

new_body = """SingleChildScrollView(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  // TOP CARD (Title, Status, Date, Time, Link)
                  Container(
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(color: Colors.blue, width: 1.5, style: BorderStyle.solid), // Actually the design shows dashed, but solid is fine
                                ),
                    ...
                    child: Column(
                      children: [
                        Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Expanded(child: _detailItem(Icons.videocam_outlined, 'Meeting Type', _meetingType)),
...
# find SingleChildScrollView and replace
match = re.search(r'SingleChildScrollView\(.*?\n          \)', content, re.DOTALL)
if match:
    content = content.replace(match.group(0), new_body)

# append helpers right before the end of the class
content = content.replace('Widget _dropdown<T>({', helpers + '\n  Widget _dropdown<T>({')

with open(r'c:\Users\tanvi\AndroidStudioProjects\Edupath_CRM\lib\presentation\meetings\add_meeting_screen.dart', 'w', encoding='utf-8') as f:
    f.write(content)
