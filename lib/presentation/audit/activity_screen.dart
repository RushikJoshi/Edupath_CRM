...
import '../../bloc/audit_log/audit_log_event.dart';
import '../../bloc/audit_log/audit_log_state.dart';
              ...
              child: items.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) =>
                          _LogTile(log: items[index], formatDate: _formatDate),
                    ),
            );
          },
        ),
...
class _LogTile extends StatelessWidget {
  const _LogTile({required this.log, required this.formatDate});
  ...
  @override
  Widget build(BuildContext context) {
    final initials = log.userName.isNotEmpty
        ? log.userName
              .trim()
              .split(' ')
              .map((p) => p[0])
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (log.changesFrom.isNotEmpty ||
                          log.changesTo.isNotEmpty)
                        Container(
                      ...
                      Container(
                        ...
                        child: Text(
                          '${displayEntity.toUpperCase()} · ${displayAction.toUpperCase()}',
                          style: GoogleFonts.poppins(
                            fontSize: 9,
                            fontWeight: FontWeight.w700,
