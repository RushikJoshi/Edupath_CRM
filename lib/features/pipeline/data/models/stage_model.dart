...
class StageModel extends Equatable {
  ...
  factory StageModel.fromJson(Map<String, dynamic> json) {
    return StageModel(
      ...
      probability: json['probability'] != null ? int.tryParse(json['probability'].toString()) ?? 0 : 0,
      winLikelihood: (json['winLikelihood'] ?? json['win_likelihood'] ?? 'open').toString(),
  ...
  @override
  List<Object?> get props => [id, name, pipelineId, order, probability, winLikelihood, color];
}
