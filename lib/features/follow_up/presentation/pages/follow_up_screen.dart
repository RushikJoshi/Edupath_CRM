...
class _FollowUpScreenState extends State<FollowUpScreen>
  ...
  Future<void> _showStatusUpdateDialog(
    ...
    final noteCtrl = TextEditingController(
      text: 'Updated status to $newStatus',
    );
    final formKey = GlobalKey<FormState>();
  ...
  Widget build(BuildContext context) {
    return MultiBlocListener(
            ...
            if (leadState.status == AppStatus.success &&
              ...
              if (!_isLeadLocked) {
                if (_selectedLeadId == null) {
                  ...
                  context.read<FollowUpBloc>().add(
                    FollowUpsFetched(_selectedLeadId!),
                  );
                } else {
                ...
                final matchedList = leadState.items.where(
                  (l) => l.id == _selectedLeadId,
                );
      ...
      child: Scaffold(
        ...
        drawer: _isLeadLocked
            ? null
            : const AppDrawer(activeRoute: '/follow-up'),
        appBar: AppBar(
        ...
        floatingActionButton: _selectedLeadId != null
            ? FloatingActionButton.extended(
                onPressed: () =>
                    _showFollowUpBottomSheet(context, _selectedLeadId!),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: GoogleFonts.poppins(
                            fontSize: 13.sp,
                            color: _currentLead == null
                                ? const Color(0xFF64748B)
                                : const Color(0xFF1E293B),
                            fontWeight: _currentLead == null
                                ? FontWeight.normal
                                : FontWeight.w500,
                          ),
                        ),
  ...
  void _showLeadSelectionBottomSheet(
    BuildContext context,
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      onTap: () {
                        ...
                        this.context.read<FollowUpBloc>().add(
                          FollowUpsFetched(lead.id),
                        );
                        Navigator.pop(ctx);
                      },
                    );
